...
export class ReviewResponseDto {
  ...
  @ApiProperty({ description: 'Author.', format: 'uuid', example: '3f2504e0-4f89-11d3-9a0c-0305e82c3301' })
  userId!: string;

  @ApiProperty({ description: 'Reviewed activity.', format: 'uuid', example: 'c48a1f60-7b22-4d19-9e33-5a0b6d2c8f41' })
  activityId!: string;

  @ApiProperty({ description: 'Rating from 1 to 5.', minimum: 1, maximum: 5, example: 5 })
  rating!: number;

  @ApiProperty({ description: 'Free-text review.', example: 'Vale muito a pena, mas va cedo para evitar fila.', nullable: true })
  comment!: string | null;

  @ApiProperty({ description: 'When the review was written.', type: String, format: 'date-time', example: '2026-08-02T19:45:00.000Z' })
  createdAt!: Date;
