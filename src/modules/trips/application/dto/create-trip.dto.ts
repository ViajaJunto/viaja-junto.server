...
export class CreateTripDto {
  ...
  @ApiPropertyOptional({
    description: 'First day of the trip (ISO 8601).',
    type: String,
    format: 'date',
    example: '2026-07-01',
  })
  ...
  @ApiPropertyOptional({
    description:
      'Last day of the trip (ISO 8601). Must not be earlier than startDate.',
    type: String,
    format: 'date',
    example: '2026-07-15',
  })
  ...
  @ApiPropertyOptional({
    description: 'Planning stage. Defaults to PLANNING.',
